module NetworkStubs
  ...
  def stub_download_request_received_failure
    stub_download_request_received
      .to_return(
        status: 400,
        body: fixture("authentication/failure_auth_response.xml"),
        headers: {
  ...
  def stub_download_request_received_success
    stub_download_request_received
      .to_return(
        status: 200,
        body: fixture("download_request_received/success_response.xml"),
        headers: RESP_HEADERS
      )
  end

  def stub_download_request_received_failure_codestatus_300
    stub_download_request_received
      .to_return(
        status: 200,
        headers: RESP_HEADERS,
        body: fixture("download_request_received/failure_response_codestatus_300.xml")
      )
  end
  ...
  def stub_download_request_received
    stub_request(:post,
      "https://cfdidescargamasivasolicitud.clouda.sat.gob.mx/SolicitaDescargaService.svc")
      .with(
        headers: {
  ...
  def stub_verify_request_success(access_token:, body:)
    stub_verify_request(access_token:)
      .to_return(
        status: 200,
        body:,
        headers: RESP_HEADERS
  ...
  def stub_verify_request_failure(access_token:)
    stub_verify_request(access_token:)
      .to_return(
        status: 401,
        body: fixture("authentication/failure_auth_response.xml"),
  ...
  def stub_verify_request(access_token:)
    stub_request(:post,
